...
import RPStep02Modal from "./RPStep02Modal";

const RPStep01ModalWrap = styled.div`
  background-color: #fff;
  border-radius: 20px 20px 0 0;
`

const RPStep01ModalBody = styled.div`
  overflow-y: scroll;
`
