...
import RPCase0202Modal from "../../documentModal/Case02/RPCase0202Modal";
import RPC02Step02Modal from "./RPC02Step02Modal";

const RPC02Step01ModalWrap = styled.div`
...
const RPC02Step01ModalBody = styled.div`
  overflow-y: scroll;
  padding-bottom: 70px;
`
...
const RPC02Step01Modal = () => {
  ...
  </RPC02Step01ModalWrap>
}

export default RPC02Step01Modal;