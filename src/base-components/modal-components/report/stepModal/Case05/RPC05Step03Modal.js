...
import RPC05Step02Modal from "./RPC05Step02Modal";
import RPC05Step04Modal from "./RPC05Step04Modal";



const RPC05Step03ModalWrap = styled.div`
...
const RPC05Step03ModalBody = styled.div`
  overflow-y: scroll;
  padding-bottom: 70px;
`
  ...
  return <RPC05Step03ModalWrap>
    ...
    <RPC05Step03ModalBody>
      ...
      <ModalBtm>
        ...
        closeModal()
        openModal({ ...modalData, content: <RPC05Step02Modal /> })
      }}>이전</button>
        <button className="primary-btn" onClick={() => {
        closeModal()
        openModal({ ...modalData, content: <RPC05Step04Modal /> })
      }}>다음</button>
      </ModalBtm>
    </RPC05Step03ModalBody>
  </RPC05Step03ModalWrap>
}

export default RPC05Step03Modal;