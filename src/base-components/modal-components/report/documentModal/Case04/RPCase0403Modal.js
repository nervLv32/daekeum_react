...
const RPCase0403Modal = () => {
  ...
  return <RPCase0402ModalWrap>
    ...
    <RPModalSearch dep1={firstExport.client.업체명} dep2={firstExport.site.현장명} dep3={null} changeParam={changeParam}/>    <RPModalBody>
...
export default RPCase0403Modal
